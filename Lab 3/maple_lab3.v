...
module SingleCycleCPU(halt, clk, rst);
   ...
   // IF
   // holds the current PC, fetches instruction from im
   // computes PC + 4 for the next sequential instruction
   ...
   // selects correct byte based on address alignment
